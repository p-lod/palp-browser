    ...
    with main(cls="container", role="main"):
      ...
      with div(id="images", style="margin-top:8px"):
        with div(style="width:80%"):
          i(f"Note: For the time being, PALP may include images below that do not directly show '{r.identifier}'. This can be because they show details or overviews of a wall-painting or other artwork that does. The selection of images will become more limited and relevant as development and data-entry continue.", style="width:80%")
        palp_image_gallery(r)
